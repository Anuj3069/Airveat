          ...
          <div class="category-section"
            ...
            <div class="service-grid" *ngIf="category.slug === 'home-cleaning' || category.slug === 'painting-renovation' || category.slug === 'salon-at-home' || category.slug === 'ac-repair'">
              <div class="service-card" *ngFor="let service of category.services; let i = index"
                ...
                <div class="card-image">
                  <div class="card-img-placeholder" [style.background]="getGradient(service.id)">
                    <span class="material-icons-outlined">{{ getCategoryIcon(category.slug) }}</span>
                  </div>
            ...
            <div class="bento-grid" *ngIf="category.slug === 'electrical-plumbing'">
              ...
              <div class="bento-featured"
                ...
                <div class="bento-featured-img" [style.background]="getGradient(featured.id)">
                  <span class="material-icons-outlined" style="font-size:64px">electrical_services</span>
              ...
              <div class="bento-side">
                <div class="bento-side-card"
                     *ngFor="let service of category.services.slice(1)"
                     [routerLink]="['/services', service.id]">
                  <div class="bento-side-img" [style.background]="getGradient(service.id)">
                    <span class="material-icons-outlined">{{ service.id === 'leaking-pipe-fix' ? 'plumbing' : 'power' }}</span>
                  </div>
